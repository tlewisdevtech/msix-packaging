...
// Helper used for QueryInterface defines. Every new interface should be lister here.
template<typename T>
struct False
{
...
#define MSIX_INTERFACE(Type,l,w1,w2,b1,b2,b3,b4,b5,b6,b7,b8)                      \
    interface Type;                                                               \
    static constexpr const IID IID_##Type  = {l,w1,w2,{b1,b2,b3,b4,b5,b6,b7,b8}}; \
    template<>                                                                    \
...
// These interfaces already have an IID_I* for windows. We still need its UuidOfImpl specialization
